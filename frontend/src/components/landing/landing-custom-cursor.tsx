...
const HOVER_SELECTOR =
  "a, button, .landing-feat, .landing-stat, .landing-step, .landing-score-card-big, .landing-flag-list li, .landing-roast-dropzone, .landing-field-input, .landing-roast-textarea, .landing-text-link, .landing-roast-file-remove, .landing-dash-share-btn, .score-card-root, .landing-notes-drawer-scrim, .landing-notes-drawer-sheet, .landing-notes-drawer-icon-btn, .landing-notes-drawer-edit, .landing-notes-drawer-done";
