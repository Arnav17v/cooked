...
const HOVER_SELECTOR =
  "a, button, .landing-feat, .landing-stat, .landing-step, .landing-score-card-big, .landing-flag-list li, .roast-dropzone, .roast-field-input, .roast-field-select, .roast-textarea, .roast-text-link, .roast-file-remove, .landing-dash-share-btn, .score-card-root, .landing-notes-drawer-scrim, .landing-notes-drawer-sheet, .landing-notes-drawer-icon-btn, .landing-notes-drawer-edit, .landing-notes-drawer-done, .landing-nav-menu-btn, .landing-dash-mobile-tab";
